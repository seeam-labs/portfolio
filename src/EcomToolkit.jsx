...
function ShareButtons() {
    ...
    // Generate a deep-link to this specific guide
    const getShareUrl = () => {
        if (typeof window === 'undefined') return 'https://seeam.vercel.app/?v=ecom-toolkit';
        const baseUrl = window.location.origin + window.location.pathname;
        return `${baseUrl}?v=ecom-toolkit`;
    };
    ...
    const shareWA = () => {
        const text = `E-Commerce ব্যবসার জন্য অপরিহার্য টুলস ও গাইডটি দেখুন: ${url}`;
    ...
    const shareTW = () => {
        const text = `ই-কমার্স টুলকিট ২০২৫ - Seeam Rahman`;
    ...
    return (
        <div style={{ marginTop: 40, position: 'relative', zIndex: 10 }}>
            <div style={{ fontSize: 11, color: "var(--t3)", fontFamily: "'Exo 2',sans-serif", textTransform: 'uppercase', letterSpacing: 2, marginBottom: 16, textAlign: 'center' }}>গাইডটি শেয়ার করুন</div>
            <div className="share-wrap" style={{ marginTop: 0 }}>
                ...
                <div style={{ width: 1, height: 24, background: 'var(--b0)', margin: '0 5px' }} />
                <button className="share-btn share-fb" onClick={shareFB} title="Share on Facebook">
                    <svg width="18" height="18" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" /></svg>
                </button>
                <button className="share-btn share-wa" onClick={shareWA} title="Share on WhatsApp">
                ...
                <button className="share-btn share-li" onClick={shareLI} title="Share on LinkedIn">
                    <svg width="18" height="18" fill="currentColor" viewBox="0 0 24 24"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z" /></svg>
                </button>
                <button className="share-btn share-tw" onClick={shareTW} title="Share on X">
                    <svg width="16" height="16" fill="currentColor" viewBox="0 0 24 24"><path d="M18.901 1.153h3.68l-8.04 9.19L24 22.846h-7.406l-5.8-7.584-6.638 7.584H.474l8.6-9.83L0 1.154h7.594l5.243 6.932 6.064-6.932zm-1.292 19.49h2.039L6.486 3.24H4.298L17.61 20.644z" /></svg>
                </button>
            </div>
...
/* ─── Main Export ─────────────────────────────────────────────────────────────── */
export default function EcomToolkit() {
    ...
    useEffect(() => {
        ...
        document.title = "Ecom Toolkit | SME E-Commerce Toolkit 2025 by Seeam Rahman";
        ...
        if (ogImage) ogImage.setAttribute('content', '/ecom-toolkit-thumbnail.png');

        // Update Twitter Image
        const twImage = document.querySelector('meta[property="twitter:image"]');
        const prevTw = twImage ? twImage.getAttribute('content') : '';
        if (twImage) twImage.setAttribute('content', '/ecom-toolkit-thumbnail.png');
            ...
            <div className="page">
                ...
                <div className="wrap">
                    ...
                    <div className="hero">
                        ...
                        <h1 className="hero-title">ই-কমার্স ব্যবসার জন্য<br />অপরিহার্য টুলকিট</h1>
